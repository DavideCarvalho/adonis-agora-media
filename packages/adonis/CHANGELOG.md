...
- [#76](https://github.com/DavideCarvalho/adonis-agora-media/pull/76) [`eb15100`](https://github.com/DavideCarvalho/adonis-agora-media/commit/eb15100f5b9cda54d1cbd5a4378a4a1d0f80774c) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Console: new `objectUrls` option — report object URLs through the console's own proxy, for a store
...
- [#67](https://github.com/DavideCarvalho/adonis-agora-media/pull/67) [`ede5aba`](https://github.com/DavideCarvalho/adonis-agora-media/commit/ede5aba7acf0b83c8c2338eeb521b34df6bf785a) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Console: a refused page navigation now gets a real page instead of `{"error":"Unauthorized"}`,
